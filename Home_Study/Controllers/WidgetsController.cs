...
namespace Home_Study.Controllers
{
    ...
    {
        private WidgetContext db = new WidgetContext();
        ...
        public ActionResult Create([Bind(Include = "Id,Name,PartNum,Description")] Widget widget)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,PartNum,Description")] Widget widget)
        {
            if (ModelState.IsValid)
            {
